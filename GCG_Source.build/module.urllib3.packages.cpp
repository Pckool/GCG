...
static PyObject *const_str_digest_a1681738c1af58638f0853df0ed71d45;
...
static void createModuleConstants( void )
{
    ...
    const_str_digest_a1681738c1af58638f0853df0ed71d45 = UNSTREAM_STRING( &constant_bin[ 1949976 ], 28, 0 );
    const_str_digest_2466748527a23d3a5c340815d3ba8b7c = UNSTREAM_STRING( &constant_bin[ 1950004 ], 25, 0 );
...
static PyCodeObject *codeobj_1445d977090024d330151f9618a96644;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_a1681738c1af58638f0853df0ed71d45 );
    codeobj_1445d977090024d330151f9618a96644 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_2466748527a23d3a5c340815d3ba8b7c, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_1445d977090024d330151f9618a96644;
    ...
    // Frame without reuse.
    frame_1445d977090024d330151f9618a96644 = MAKE_MODULE_FRAME( codeobj_1445d977090024d330151f9618a96644, module_urllib3$packages );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_1445d977090024d330151f9618a96644 );
    assert( Py_REFCNT( frame_1445d977090024d330151f9618a96644 ) == 2 );

    // Framed code:
    tmp_assign_source_3 = PyList_New( 3 );
    frame_1445d977090024d330151f9618a96644->m_frame.f_lineno = 1;
    {
    ...
    tmp_args_element_name_4 = const_str_digest_65485c760cca56a20b50455ef338794c;
    ...
    frame_1445d977090024d330151f9618a96644->m_frame.f_lineno = 3;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_1445d977090024d330151f9618a96644 );
#endif
    popFrameStack();

    assertFrameObject( frame_1445d977090024d330151f9618a96644 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_1445d977090024d330151f9618a96644, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_1445d977090024d330151f9618a96644->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_1445d977090024d330151f9618a96644, exception_lineno );
    }
