...
static PyObject *const_str_digest_222c078a82b05334159ebc38dfd710ce;
...
static PyObject *const_dict_8252b01002e229ba8d6fb3781080a93a;
...
{
    const_str_digest_dc79ec5cbcd38530b7ee96bca471ee48 = UNSTREAM_STRING( &constant_bin[ 624700 ], 21, 0 );
    const_str_digest_222c078a82b05334159ebc38dfd710ce = UNSTREAM_STRING( &constant_bin[ 624721 ], 24, 0 );
    const_str_digest_ae9d6528e772a9a1abf503ee28557204 = UNSTREAM_STRING( &constant_bin[ 624745 ], 30, 0 );
    const_str_plain_ThaiLangModel = UNSTREAM_STRING( &constant_bin[ 624775 ], 13, 1 );
    const_str_plain_TIS620CharToOrderMap = UNSTREAM_STRING( &constant_bin[ 624788 ], 20, 1 );
    const_tuple_7d72fee6787d507d887d69cdea35a4a9_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 624808 ], 1285 );
    const_tuple_d3af699605e5a0a7fd9bffcfaf0dd97e_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 626093 ], 20485 );
    const_dict_8252b01002e229ba8d6fb3781080a93a = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 646578 ], 21904 );
...
static PyCodeObject *codeobj_377c3fb9719d2c03d6218f303043f0f4;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_222c078a82b05334159ebc38dfd710ce );
    codeobj_377c3fb9719d2c03d6218f303043f0f4 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_ae9d6528e772a9a1abf503ee28557204, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_377c3fb9719d2c03d6218f303043f0f4;
    ...
    // Frame without reuse.
    frame_377c3fb9719d2c03d6218f303043f0f4 = MAKE_MODULE_FRAME( codeobj_377c3fb9719d2c03d6218f303043f0f4, module_chardet$langthaimodel );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_377c3fb9719d2c03d6218f303043f0f4 );
    assert( Py_REFCNT( frame_377c3fb9719d2c03d6218f303043f0f4 ) == 2 );

    // Framed code:
    frame_377c3fb9719d2c03d6218f303043f0f4->m_frame.f_lineno = 1;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_377c3fb9719d2c03d6218f303043f0f4 );
#endif
    popFrameStack();

    assertFrameObject( frame_377c3fb9719d2c03d6218f303043f0f4 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_377c3fb9719d2c03d6218f303043f0f4, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_377c3fb9719d2c03d6218f303043f0f4->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_377c3fb9719d2c03d6218f303043f0f4, exception_lineno );
    }
    ...
    tmp_assign_source_9 = PyDict_Copy( const_dict_8252b01002e229ba8d6fb3781080a93a );
