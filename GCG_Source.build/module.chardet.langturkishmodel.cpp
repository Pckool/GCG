...
static PyObject *const_dict_38d85809966b96fdebe0851e9dc64c81;
...
static PyObject *const_str_digest_d86ed6c0d4d851111712eea2af5c983a;
...
{
    const_str_plain_Latin5_TurkishCharToOrderMap = UNSTREAM_STRING( &constant_bin[ 668482 ], 28, 1 );
    const_str_plain_TurkishLangModel = UNSTREAM_STRING( &constant_bin[ 668510 ], 16, 1 );
    const_str_digest_9a8cb319aec60ead0975237a9305202f = UNSTREAM_STRING( &constant_bin[ 668526 ], 33, 0 );
    const_dict_38d85809966b96fdebe0851e9dc64c81 = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 668559 ], 21910 );
    const_tuple_f2c470729e0f10e437bc567e306ce1de_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 690469 ], 1285 );
    const_str_digest_505db4dfed8ce57136b6a88fb660a1e2 = UNSTREAM_STRING( &constant_bin[ 668534 ], 24, 0 );
    const_tuple_439339857850830237fd4916bd45a217_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 691754 ], 20485 );
    const_str_digest_d86ed6c0d4d851111712eea2af5c983a = UNSTREAM_STRING( &constant_bin[ 712239 ], 27, 0 );
...
static PyCodeObject *codeobj_9628ebd8c7e69c569293a1378543cfee;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_d86ed6c0d4d851111712eea2af5c983a );
    codeobj_9628ebd8c7e69c569293a1378543cfee = MAKE_CODEOBJ( module_filename_obj, const_str_digest_9a8cb319aec60ead0975237a9305202f, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_9628ebd8c7e69c569293a1378543cfee;
    ...
    // Frame without reuse.
    frame_9628ebd8c7e69c569293a1378543cfee = MAKE_MODULE_FRAME( codeobj_9628ebd8c7e69c569293a1378543cfee, module_chardet$langturkishmodel );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_9628ebd8c7e69c569293a1378543cfee );
    assert( Py_REFCNT( frame_9628ebd8c7e69c569293a1378543cfee ) == 2 );

    // Framed code:
    frame_9628ebd8c7e69c569293a1378543cfee->m_frame.f_lineno = 1;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_9628ebd8c7e69c569293a1378543cfee );
#endif
    popFrameStack();

    assertFrameObject( frame_9628ebd8c7e69c569293a1378543cfee );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_9628ebd8c7e69c569293a1378543cfee, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_9628ebd8c7e69c569293a1378543cfee->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_9628ebd8c7e69c569293a1378543cfee, exception_lineno );
    }
    ...
    tmp_assign_source_9 = PyDict_Copy( const_dict_38d85809966b96fdebe0851e9dc64c81 );
