...
static PyObject *const_str_digest_dbe8fd23863001322064d048a64c7632;
...
{
    const_str_digest_014d7364d9b7728f9db9c7c9e73a5813 = UNSTREAM_STRING( &constant_bin[ 728688 ], 15, 0 );
    const_str_digest_96baa068c2199be2cd71dcff3a585dfa = UNSTREAM_STRING( &constant_bin[ 728703 ], 24, 0 );
    const_str_digest_5f28c8ec13a43e2288b9f6b9b20df422 = UNSTREAM_STRING( &constant_bin[ 728727 ], 5, 0 );
    const_str_digest_273bc0eb91233c9ce50bbc2a025b5f82 = UNSTREAM_STRING( &constant_bin[ 728732 ], 179, 0 );
    const_str_digest_dbe8fd23863001322064d048a64c7632 = UNSTREAM_STRING( &constant_bin[ 728911 ], 18, 0 );
...
static PyCodeObject *codeobj_211bd12f16ba8e8ed37871765cede3e2;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_dbe8fd23863001322064d048a64c7632 );
    codeobj_211bd12f16ba8e8ed37871765cede3e2 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_96baa068c2199be2cd71dcff3a585dfa, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_211bd12f16ba8e8ed37871765cede3e2;
    ...
    // Frame without reuse.
    frame_211bd12f16ba8e8ed37871765cede3e2 = MAKE_MODULE_FRAME( codeobj_211bd12f16ba8e8ed37871765cede3e2, module_chardet$version );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_211bd12f16ba8e8ed37871765cede3e2 );
    assert( Py_REFCNT( frame_211bd12f16ba8e8ed37871765cede3e2 ) == 2 );

    // Framed code:
    frame_211bd12f16ba8e8ed37871765cede3e2->m_frame.f_lineno = 1;
    {
    ...
    frame_211bd12f16ba8e8ed37871765cede3e2->m_frame.f_lineno = 9;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_211bd12f16ba8e8ed37871765cede3e2 );
#endif
    popFrameStack();

    assertFrameObject( frame_211bd12f16ba8e8ed37871765cede3e2 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_211bd12f16ba8e8ed37871765cede3e2, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_211bd12f16ba8e8ed37871765cede3e2->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_211bd12f16ba8e8ed37871765cede3e2, exception_lineno );
    }
