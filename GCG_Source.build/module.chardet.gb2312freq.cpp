...
static PyObject *const_str_digest_54bb86757da1fb64506eff0a67d090e3;
...
static void createModuleConstants( void )
{
    ...
    const_str_digest_029d83c1badb1ab709cf2ef82b2ab5c5 = UNSTREAM_STRING( &constant_bin[ 210119 ], 18, 0 );
    const_str_digest_54bb86757da1fb64506eff0a67d090e3 = UNSTREAM_STRING( &constant_bin[ 210137 ], 21, 0 );
    const_float_0_9 = UNSTREAM_FLOAT( &constant_bin[ 210158 ] );
    const_str_digest_bd2566f31416359c4974c22f2bdb7f53 = UNSTREAM_STRING( &constant_bin[ 210166 ], 27, 0 );
    const_tuple_dde085f8e55d1c62c7c408697fac7cf3_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 210193 ], 18805 );
...
static PyCodeObject *codeobj_ea09826a348d5a3045efaf9e9a20afe6;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_54bb86757da1fb64506eff0a67d090e3 );
    codeobj_ea09826a348d5a3045efaf9e9a20afe6 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_bd2566f31416359c4974c22f2bdb7f53, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_ea09826a348d5a3045efaf9e9a20afe6;
    ...
    // Frame without reuse.
    frame_ea09826a348d5a3045efaf9e9a20afe6 = MAKE_MODULE_FRAME( codeobj_ea09826a348d5a3045efaf9e9a20afe6, module_chardet$gb2312freq );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_ea09826a348d5a3045efaf9e9a20afe6 );
    assert( Py_REFCNT( frame_ea09826a348d5a3045efaf9e9a20afe6 ) == 2 );

    // Framed code:
    frame_ea09826a348d5a3045efaf9e9a20afe6->m_frame.f_lineno = 1;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_ea09826a348d5a3045efaf9e9a20afe6 );
#endif
    popFrameStack();

    assertFrameObject( frame_ea09826a348d5a3045efaf9e9a20afe6 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_ea09826a348d5a3045efaf9e9a20afe6, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_ea09826a348d5a3045efaf9e9a20afe6->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_ea09826a348d5a3045efaf9e9a20afe6, exception_lineno );
    }
