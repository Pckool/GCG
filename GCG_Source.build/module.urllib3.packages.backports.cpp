...
static PyObject *const_str_digest_722c95726ec76e3f15c07dcf3a4259c6;
...
static PyObject *const_str_digest_7e98b8048b44ce949e32ba3fb323a965;
...
static void createModuleConstants( void )
{
    ...
    const_str_digest_b1736aa08ebcc1a187702783619ce9b8 = UNSTREAM_STRING( &constant_bin[ 1950029 ], 41, 1 );
    ...
    const_str_digest_ad8147c298b62c889289704513633c71 = UNSTREAM_STRING( &constant_bin[ 1950070 ], 35, 0 );
    const_str_digest_722c95726ec76e3f15c07dcf3a4259c6 = UNSTREAM_STRING( &constant_bin[ 1950105 ], 38, 0 );
    const_str_digest_7e98b8048b44ce949e32ba3fb323a965 = UNSTREAM_STRING( &constant_bin[ 1950113 ], 18, 0 );
    const_str_plain_backports = UNSTREAM_STRING( &constant_bin[ 1028612 ], 9, 1 );
...
static PyCodeObject *codeobj_cab9a0444574be1521bd21c3e583e8b8;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_722c95726ec76e3f15c07dcf3a4259c6 );
    codeobj_cab9a0444574be1521bd21c3e583e8b8 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_ad8147c298b62c889289704513633c71, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_cab9a0444574be1521bd21c3e583e8b8;
    ...
    // Frame without reuse.
    frame_cab9a0444574be1521bd21c3e583e8b8 = MAKE_MODULE_FRAME( codeobj_cab9a0444574be1521bd21c3e583e8b8, module_urllib3$packages$backports );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_cab9a0444574be1521bd21c3e583e8b8 );
    assert( Py_REFCNT( frame_cab9a0444574be1521bd21c3e583e8b8 ) == 2 );

    // Framed code:
    tmp_assign_source_3 = PyList_New( 4 );
    frame_cab9a0444574be1521bd21c3e583e8b8->m_frame.f_lineno = 1;
    {
    ...
    tmp_args_element_name_3 = const_str_digest_7e98b8048b44ce949e32ba3fb323a965;
    frame_cab9a0444574be1521bd21c3e583e8b8->m_frame.f_lineno = 1;
    {
    ...
    tmp_args_element_name_6 = const_str_digest_650f585b546df29797de13514560918c;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_cab9a0444574be1521bd21c3e583e8b8 );
#endif
    popFrameStack();

    assertFrameObject( frame_cab9a0444574be1521bd21c3e583e8b8 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_cab9a0444574be1521bd21c3e583e8b8, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_cab9a0444574be1521bd21c3e583e8b8->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_cab9a0444574be1521bd21c3e583e8b8, exception_lineno );
    }
