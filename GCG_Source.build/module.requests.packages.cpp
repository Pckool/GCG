...
{
    const_str_digest_290723d2b2c871d74313a87489f6fef2 = UNSTREAM_STRING( &constant_bin[ 1842387 ], 17, 0 );
    const_str_digest_dbcc67b71a3f74ff3cb118b7bb26cbd2 = UNSTREAM_STRING( &constant_bin[ 1842404 ], 18, 0 );
    const_str_digest_89ccadda80a7f20ba8ae2e3697c043ec = UNSTREAM_STRING( &constant_bin[ 1842422 ], 26, 0 );
    ...
    const_str_digest_9a6581892f09eb64c1c676850f20f3fc = UNSTREAM_STRING( &constant_bin[ 1842448 ], 20, 0 );
...
static PyCodeObject *codeobj_a9b9f4cd76ab7b14239549832f8fc1ff;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_9a6581892f09eb64c1c676850f20f3fc );
    codeobj_a9b9f4cd76ab7b14239549832f8fc1ff = MAKE_CODEOBJ( module_filename_obj, const_str_digest_89ccadda80a7f20ba8ae2e3697c043ec, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_a9b9f4cd76ab7b14239549832f8fc1ff;
    ...
    // Frame without reuse.
    frame_a9b9f4cd76ab7b14239549832f8fc1ff = MAKE_MODULE_FRAME( codeobj_a9b9f4cd76ab7b14239549832f8fc1ff, module_requests$packages );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_a9b9f4cd76ab7b14239549832f8fc1ff );
    assert( Py_REFCNT( frame_a9b9f4cd76ab7b14239549832f8fc1ff ) == 2 );

    // Framed code:
    frame_a9b9f4cd76ab7b14239549832f8fc1ff->m_frame.f_lineno = 1;
    {
    ...
    frame_a9b9f4cd76ab7b14239549832f8fc1ff->m_frame.f_lineno = 7;
    ...
    frame_a9b9f4cd76ab7b14239549832f8fc1ff->m_frame.f_lineno = 11;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_a9b9f4cd76ab7b14239549832f8fc1ff );
#endif
    popFrameStack();

    assertFrameObject( frame_a9b9f4cd76ab7b14239549832f8fc1ff );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_a9b9f4cd76ab7b14239549832f8fc1ff, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_a9b9f4cd76ab7b14239549832f8fc1ff->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_a9b9f4cd76ab7b14239549832f8fc1ff, exception_lineno );
    }
