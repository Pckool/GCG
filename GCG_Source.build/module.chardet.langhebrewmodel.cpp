...
static PyObject *const_dict_2fe50d34c00e70b97fd16aaa85351901;
...
static PyObject *const_str_digest_7471331e815247d0957c902583d31a71;
...
{
    const_tuple_4f19fa3634bb485716df7f8f5e81152b_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 580896 ], 1285 );
    const_dict_2fe50d34c00e70b97fd16aaa85351901 = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 582181 ], 21911 );
    const_str_plain_WIN1255_CHAR_TO_ORDER_MAP = UNSTREAM_STRING( &constant_bin[ 604092 ], 25, 1 );
    const_str_digest_7471331e815247d0957c902583d31a71 = UNSTREAM_STRING( &constant_bin[ 604117 ], 26, 0 );
    const_str_digest_e47a8de6b5727c65c2c3c97877c79198 = UNSTREAM_STRING( &constant_bin[ 604143 ], 23, 0 );
    const_str_digest_7eaa2e05b6adbe04ee0f16efc52eb3a0 = UNSTREAM_STRING( &constant_bin[ 604166 ], 32, 0 );
    const_tuple_96aea69e7c6c4b34b6c5234187423b87_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 604198 ], 20485 );
    const_str_plain_HEBREW_LANG_MODEL = UNSTREAM_STRING( &constant_bin[ 624683 ], 17, 1 );
...
static PyCodeObject *codeobj_6037085864c4fc0a52477115e71ed332;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_7471331e815247d0957c902583d31a71 );
    codeobj_6037085864c4fc0a52477115e71ed332 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_7eaa2e05b6adbe04ee0f16efc52eb3a0, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_6037085864c4fc0a52477115e71ed332;
    ...
    // Frame without reuse.
    frame_6037085864c4fc0a52477115e71ed332 = MAKE_MODULE_FRAME( codeobj_6037085864c4fc0a52477115e71ed332, module_chardet$langhebrewmodel );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_6037085864c4fc0a52477115e71ed332 );
    assert( Py_REFCNT( frame_6037085864c4fc0a52477115e71ed332 ) == 2 );

    // Framed code:
    frame_6037085864c4fc0a52477115e71ed332->m_frame.f_lineno = 1;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_6037085864c4fc0a52477115e71ed332 );
#endif
    popFrameStack();

    assertFrameObject( frame_6037085864c4fc0a52477115e71ed332 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_6037085864c4fc0a52477115e71ed332, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_6037085864c4fc0a52477115e71ed332->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_6037085864c4fc0a52477115e71ed332, exception_lineno );
    }
    ...
    tmp_assign_source_9 = PyDict_Copy( const_dict_2fe50d34c00e70b97fd16aaa85351901 );
