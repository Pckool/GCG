...
static PyObject *const_dict_46ff8b88acae5e9d1a7a8199af4ac931;
...
static PyObject *const_dict_13572561089b1d1f43fb88a4e0c67d3e;
...
{
    const_tuple_d12d0d38133deb374cda3f2e99175f9b_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 286957 ], 1285 );
    const_str_plain_Latin5_BulgarianCharToOrderMap = UNSTREAM_STRING( &constant_bin[ 288242 ], 30, 1 );
    const_dict_46ff8b88acae5e9d1a7a8199af4ac931 = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 288272 ], 21912 );
    const_str_digest_d5ffc5d3d4577ce00b154e8a3a81f139 = UNSTREAM_STRING( &constant_bin[ 310184 ], 26, 0 );
    const_str_plain_win1251BulgarianCharToOrderMap = UNSTREAM_STRING( &constant_bin[ 310210 ], 30, 1 );
    const_str_plain_BulgarianLangModel = UNSTREAM_STRING( &constant_bin[ 310240 ], 18, 1 );
    const_str_digest_f162f0e48afd9bd30970a540cb56b630 = UNSTREAM_STRING( &constant_bin[ 310258 ], 35, 0 );
    const_dict_13572561089b1d1f43fb88a4e0c67d3e = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 310293 ], 21914 );
    const_tuple_36b7ecdab49c9829602e64b169986871_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 332207 ], 20485 );
    const_tuple_33562c24091b0ac3cbee9a55801943b1_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 352692 ], 1285 );
    const_str_digest_ad282e6fb1d834749d7f838b496e3813 = UNSTREAM_STRING( &constant_bin[ 353977 ], 29, 0 );
...
static PyCodeObject *codeobj_c35645fcd6faf9a5bcf82e4946853311;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_ad282e6fb1d834749d7f838b496e3813 );
    codeobj_c35645fcd6faf9a5bcf82e4946853311 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_f162f0e48afd9bd30970a540cb56b630, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_c35645fcd6faf9a5bcf82e4946853311;
    ...
    // Frame without reuse.
    frame_c35645fcd6faf9a5bcf82e4946853311 = MAKE_MODULE_FRAME( codeobj_c35645fcd6faf9a5bcf82e4946853311, module_chardet$langbulgarianmodel );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_c35645fcd6faf9a5bcf82e4946853311 );
    assert( Py_REFCNT( frame_c35645fcd6faf9a5bcf82e4946853311 ) == 2 );

    // Framed code:
    frame_c35645fcd6faf9a5bcf82e4946853311->m_frame.f_lineno = 1;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_c35645fcd6faf9a5bcf82e4946853311 );
#endif
    popFrameStack();

    assertFrameObject( frame_c35645fcd6faf9a5bcf82e4946853311 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_c35645fcd6faf9a5bcf82e4946853311, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_c35645fcd6faf9a5bcf82e4946853311->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_c35645fcd6faf9a5bcf82e4946853311, exception_lineno );
    }
    ...
    tmp_assign_source_10 = PyDict_Copy( const_dict_46ff8b88acae5e9d1a7a8199af4ac931 );
    ...
    tmp_assign_source_11 = PyDict_Copy( const_dict_13572561089b1d1f43fb88a4e0c67d3e );
