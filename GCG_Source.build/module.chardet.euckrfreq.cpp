...
static PyObject *const_str_digest_85e577ff2989f104a24d29f9edd37904;
...
{
    const_str_digest_f3fa5090e791228c73f02a2e17471df1 = UNSTREAM_STRING( &constant_bin[ 171129 ], 26, 0 );
    const_str_digest_cc56906e074538d0ada7e776069ec64d = UNSTREAM_STRING( &constant_bin[ 171137 ], 17, 0 );
    const_tuple_fb1a7aca64de80b2dca943d3e5efe888_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 171155 ], 11765 );
    const_str_digest_85e577ff2989f104a24d29f9edd37904 = UNSTREAM_STRING( &constant_bin[ 182920 ], 20, 0 );
    const_int_pos_2352 = PyLong_FromUnsignedLong( 2352ul );
    const_float_6_0 = UNSTREAM_FLOAT( &constant_bin[ 182940 ] );
...
static PyCodeObject *codeobj_f02b2dd3cc339f25b4cad7eee08c6acb;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_85e577ff2989f104a24d29f9edd37904 );
    codeobj_f02b2dd3cc339f25b4cad7eee08c6acb = MAKE_CODEOBJ( module_filename_obj, const_str_digest_f3fa5090e791228c73f02a2e17471df1, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_f02b2dd3cc339f25b4cad7eee08c6acb;
    ...
    // Frame without reuse.
    frame_f02b2dd3cc339f25b4cad7eee08c6acb = MAKE_MODULE_FRAME( codeobj_f02b2dd3cc339f25b4cad7eee08c6acb, module_chardet$euckrfreq );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_f02b2dd3cc339f25b4cad7eee08c6acb );
    assert( Py_REFCNT( frame_f02b2dd3cc339f25b4cad7eee08c6acb ) == 2 );

    // Framed code:
    frame_f02b2dd3cc339f25b4cad7eee08c6acb->m_frame.f_lineno = 1;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_f02b2dd3cc339f25b4cad7eee08c6acb );
#endif
    popFrameStack();

    assertFrameObject( frame_f02b2dd3cc339f25b4cad7eee08c6acb );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_f02b2dd3cc339f25b4cad7eee08c6acb, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_f02b2dd3cc339f25b4cad7eee08c6acb->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_f02b2dd3cc339f25b4cad7eee08c6acb, exception_lineno );
    }
