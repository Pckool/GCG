...
static PyObject *const_dict_88b355a6f52fc37e83a7356b9e8cb0ef;
...
static PyObject *const_dict_6a44f43ca22464aa7f8e042c846e48d0;
extern PyObject *const_str_plain_idna;
static PyObject *const_dict_2c4a46f6b43d14d43ba7855ace42ae1d;
...
{
    const_dict_88b355a6f52fc37e83a7356b9e8cb0ef = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 1276514 ], 5042 );
    const_str_digest_36fd0a5f22ffa55f1b167216071d6ce2 = UNSTREAM_STRING( &constant_bin[ 1281556 ], 22, 0 );
    const_dict_6a44f43ca22464aa7f8e042c846e48d0 = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 1281578 ], 883 );
    const_dict_2c4a46f6b43d14d43ba7855ace42ae1d = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 1282461 ], 11480 );
    const_str_digest_8a88317164860b547beff038de474299 = UNSTREAM_STRING( &constant_bin[ 1293941 ], 16, 0 );
    const_str_digest_4c41e0b73d97829c93c8a1dc02228f50 = UNSTREAM_STRING( &constant_bin[ 1281564 ], 13, 0 );
...
static PyCodeObject *codeobj_b4dee84a5e0e49cebf5514ff9564db8f;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_8a88317164860b547beff038de474299 );
    codeobj_b4dee84a5e0e49cebf5514ff9564db8f = MAKE_CODEOBJ( module_filename_obj, const_str_digest_36fd0a5f22ffa55f1b167216071d6ce2, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_b4dee84a5e0e49cebf5514ff9564db8f;
    ...
    // Frame without reuse.
    frame_b4dee84a5e0e49cebf5514ff9564db8f = MAKE_MODULE_FRAME( codeobj_b4dee84a5e0e49cebf5514ff9564db8f, module_idna$idnadata );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_b4dee84a5e0e49cebf5514ff9564db8f );
    assert( Py_REFCNT( frame_b4dee84a5e0e49cebf5514ff9564db8f ) == 2 );

    // Framed code:
    frame_b4dee84a5e0e49cebf5514ff9564db8f->m_frame.f_lineno = 1;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_b4dee84a5e0e49cebf5514ff9564db8f );
#endif
    popFrameStack();

    assertFrameObject( frame_b4dee84a5e0e49cebf5514ff9564db8f );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_b4dee84a5e0e49cebf5514ff9564db8f, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_b4dee84a5e0e49cebf5514ff9564db8f->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_b4dee84a5e0e49cebf5514ff9564db8f, exception_lineno );
    }
    ...
    tmp_assign_source_8 = PyDict_Copy( const_dict_6a44f43ca22464aa7f8e042c846e48d0 );
    UPDATE_STRING_DICT1( moduledict_idna$idnadata, (Nuitka_StringObject *)const_str_plain_scripts, tmp_assign_source_8 );
    tmp_assign_source_9 = PyDict_Copy( const_dict_88b355a6f52fc37e83a7356b9e8cb0ef );
    UPDATE_STRING_DICT1( moduledict_idna$idnadata, (Nuitka_StringObject *)const_str_plain_joining_types, tmp_assign_source_9 );
    tmp_assign_source_10 = PyDict_Copy( const_dict_2c4a46f6b43d14d43ba7855ace42ae1d );
