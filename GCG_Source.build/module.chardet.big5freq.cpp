...
{
    const_str_digest_22eed836741affd2ba7eb773842c665a = UNSTREAM_STRING( &constant_bin[ 132819 ], 25, 0 );
    const_tuple_0d344fc43c8fde1f903c0a27df00c4dd_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 132844 ], 26885 );
    const_str_digest_50b8614f3d83edf4cd0b5322abbd5460 = UNSTREAM_STRING( &constant_bin[ 159729 ], 19, 0 );
    const_str_digest_7f4ff06de02ab54ab001bad022a7055d = UNSTREAM_STRING( &constant_bin[ 132827 ], 16, 0 );
...
static PyCodeObject *codeobj_b1bbd5fc7a047a3bebb2fcfe857c06bd;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_50b8614f3d83edf4cd0b5322abbd5460 );
    codeobj_b1bbd5fc7a047a3bebb2fcfe857c06bd = MAKE_CODEOBJ( module_filename_obj, const_str_digest_22eed836741affd2ba7eb773842c665a, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_b1bbd5fc7a047a3bebb2fcfe857c06bd;
    ...
    // Frame without reuse.
    frame_b1bbd5fc7a047a3bebb2fcfe857c06bd = MAKE_MODULE_FRAME( codeobj_b1bbd5fc7a047a3bebb2fcfe857c06bd, module_chardet$big5freq );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_b1bbd5fc7a047a3bebb2fcfe857c06bd );
    assert( Py_REFCNT( frame_b1bbd5fc7a047a3bebb2fcfe857c06bd ) == 2 );

    // Framed code:
    frame_b1bbd5fc7a047a3bebb2fcfe857c06bd->m_frame.f_lineno = 1;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_b1bbd5fc7a047a3bebb2fcfe857c06bd );
#endif
    popFrameStack();

    assertFrameObject( frame_b1bbd5fc7a047a3bebb2fcfe857c06bd );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_b1bbd5fc7a047a3bebb2fcfe857c06bd, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_b1bbd5fc7a047a3bebb2fcfe857c06bd->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_b1bbd5fc7a047a3bebb2fcfe857c06bd, exception_lineno );
    }
