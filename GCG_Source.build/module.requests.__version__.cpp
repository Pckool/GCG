...
{
    const_str_digest_c732b0001bd9466f3f59e4e065102217 = UNSTREAM_STRING( &constant_bin[ 1807392 ], 10, 0 );
    const_str_digest_b0b40594a48ef757787421cf2d82910a = UNSTREAM_STRING( &constant_bin[ 1807434 ], 19, 0 );
    const_str_digest_f924d4e9bded95196120a23f5588dcb3 = UNSTREAM_STRING( &constant_bin[ 1807453 ], 23, 0 );
    const_str_digest_3e2093e591751aa28d709af1b89d3ffc = UNSTREAM_STRING( &constant_bin[ 1807313 ], 26, 0 );
    const_str_digest_dac880088c76a67146081efa1b2911e5 = UNSTREAM_STRING( &constant_bin[ 1807476 ], 20, 0 );
    const_int_pos_137220 = PyLong_FromUnsignedLong( 137220ul );
    const_str_digest_758f7d031ff885be82b1ada2371115dd = UNSTREAM_STRING( &constant_bin[ 1807496 ], 28, 0 );
    const_str_digest_4ff9240dea52a791e105fc1b241d7a7a = UNSTREAM_STRING( &constant_bin[ 1807524 ], 6, 0 );
    const_str_digest_6cdfef70e7012bff1e9ace07e7174bd8 = UNSTREAM_STRING( &constant_bin[ 1807530 ], 29, 0 );
    const_str_digest_4b66185fba40f207a567bf87be4d87f7 = UNSTREAM_STRING( &constant_bin[ 1807559 ], 12, 0 );
    const_str_digest_e1f5c84b9e767a5638aa03d199586242 = UNSTREAM_STRING( &constant_bin[ 1807571 ], 23, 0 );
    const_str_digest_f45d7c3ad4be7ff6c8635dcc1dd81887 = UNSTREAM_STRING( &constant_bin[ 1807367 ], 13, 0 );
...
static PyCodeObject *codeobj_14aa6736752a201305b55fbd099759da;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_e1f5c84b9e767a5638aa03d199586242 );
    codeobj_14aa6736752a201305b55fbd099759da = MAKE_CODEOBJ( module_filename_obj, const_str_digest_6cdfef70e7012bff1e9ace07e7174bd8, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_14aa6736752a201305b55fbd099759da;
    ...
    // Frame without reuse.
    frame_14aa6736752a201305b55fbd099759da = MAKE_MODULE_FRAME( codeobj_14aa6736752a201305b55fbd099759da, module_requests$__version__ );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_14aa6736752a201305b55fbd099759da );
    assert( Py_REFCNT( frame_14aa6736752a201305b55fbd099759da ) == 2 );

    // Framed code:
    frame_14aa6736752a201305b55fbd099759da->m_frame.f_lineno = 1;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_14aa6736752a201305b55fbd099759da );
#endif
    popFrameStack();

    assertFrameObject( frame_14aa6736752a201305b55fbd099759da );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_14aa6736752a201305b55fbd099759da, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_14aa6736752a201305b55fbd099759da->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_14aa6736752a201305b55fbd099759da, exception_lineno );
    }
