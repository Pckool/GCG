...
static void createModuleConstants( void )
{
    ...
    const_str_digest_7921c50912a901784d39dd11ac42768a = UNSTREAM_STRING( &constant_bin[ 1972066 ], 21, 0 );
    const_tuple_14e036ec61db220e89382c6142586324_tuple = PyTuple_New( 2 );
    const_str_plain_NUITKA_PACKAGE_urllib3_util = UNSTREAM_STRING( &constant_bin[ 1972087 ], 27, 1 );
    ...
    const_str_plain_retry = UNSTREAM_STRING( &constant_bin[ 1681301 ], 5, 1 );
    ...
    const_str_digest_753199402707a053cc9750ca853d7b09 = UNSTREAM_STRING( &constant_bin[ 1972114 ], 24, 0 );
    ...
    const_tuple_d9f55eb6f47613ec7fa8c938d9d722ac_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 1972138 ], 285 );
...
static PyCodeObject *codeobj_9d1a8966decf68f4db8878326fb4b3ba;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_753199402707a053cc9750ca853d7b09 );
    codeobj_9d1a8966decf68f4db8878326fb4b3ba = MAKE_CODEOBJ( module_filename_obj, const_str_digest_7921c50912a901784d39dd11ac42768a, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_9d1a8966decf68f4db8878326fb4b3ba;
    ...
    // Frame without reuse.
    frame_9d1a8966decf68f4db8878326fb4b3ba = MAKE_MODULE_FRAME( codeobj_9d1a8966decf68f4db8878326fb4b3ba, module_urllib3$util );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_9d1a8966decf68f4db8878326fb4b3ba );
    assert( Py_REFCNT( frame_9d1a8966decf68f4db8878326fb4b3ba ) == 2 );

    // Framed code:
    tmp_assign_source_3 = PyList_New( 3 );
    frame_9d1a8966decf68f4db8878326fb4b3ba->m_frame.f_lineno = 1;
    {
    ...
    tmp_args_element_name_4 = const_str_digest_867cf107290997ea3f46e9cff397e1db;
    ...
    frame_9d1a8966decf68f4db8878326fb4b3ba->m_frame.f_lineno = 3;
    ...
    frame_9d1a8966decf68f4db8878326fb4b3ba->m_frame.f_lineno = 4;
    ...
    frame_9d1a8966decf68f4db8878326fb4b3ba->m_frame.f_lineno = 5;
    ...
    frame_9d1a8966decf68f4db8878326fb4b3ba->m_frame.f_lineno = 6;
    ...
    frame_9d1a8966decf68f4db8878326fb4b3ba->m_frame.f_lineno = 16;
    ...
    frame_9d1a8966decf68f4db8878326fb4b3ba->m_frame.f_lineno = 21;
    ...
    frame_9d1a8966decf68f4db8878326fb4b3ba->m_frame.f_lineno = 22;
    ...
    frame_9d1a8966decf68f4db8878326fb4b3ba->m_frame.f_lineno = 28;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_9d1a8966decf68f4db8878326fb4b3ba );
#endif
    popFrameStack();

    assertFrameObject( frame_9d1a8966decf68f4db8878326fb4b3ba );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_9d1a8966decf68f4db8878326fb4b3ba, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_9d1a8966decf68f4db8878326fb4b3ba->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_9d1a8966decf68f4db8878326fb4b3ba, exception_lineno );
    }
