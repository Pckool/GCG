...
{
    const_str_plain_NUITKA_PACKAGE_idna = UNSTREAM_STRING( &constant_bin[ 1274840 ], 19, 1 );
    const_str_digest_6113d5b8ddc90108c594903d68250893 = UNSTREAM_STRING( &constant_bin[ 1274859 ], 16, 0 );
    const_str_plain_package_data = UNSTREAM_STRING( &constant_bin[ 1274875 ], 12, 1 );
    ...
    const_str_digest_b524b2931bfefb9a3de889a85999899a = UNSTREAM_STRING( &constant_bin[ 1274887 ], 13, 0 );
...
static PyCodeObject *codeobj_b56388757fe2567503c142c3ee2ad97f;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_6113d5b8ddc90108c594903d68250893 );
    codeobj_b56388757fe2567503c142c3ee2ad97f = MAKE_CODEOBJ( module_filename_obj, const_str_digest_b524b2931bfefb9a3de889a85999899a, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_b56388757fe2567503c142c3ee2ad97f;
    ...
    // Frame without reuse.
    frame_b56388757fe2567503c142c3ee2ad97f = MAKE_MODULE_FRAME( codeobj_b56388757fe2567503c142c3ee2ad97f, module_idna );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_b56388757fe2567503c142c3ee2ad97f );
    assert( Py_REFCNT( frame_b56388757fe2567503c142c3ee2ad97f ) == 2 );

    // Framed code:
    tmp_assign_source_3 = PyList_New( 2 );
    frame_b56388757fe2567503c142c3ee2ad97f->m_frame.f_lineno = 1;
    {
    ...
    tmp_args_element_name_2 = const_str_plain_idna;
    ...
    frame_b56388757fe2567503c142c3ee2ad97f->m_frame.f_lineno = 2;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_b56388757fe2567503c142c3ee2ad97f );
#endif
    popFrameStack();

    assertFrameObject( frame_b56388757fe2567503c142c3ee2ad97f );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_b56388757fe2567503c142c3ee2ad97f, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_b56388757fe2567503c142c3ee2ad97f->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_b56388757fe2567503c142c3ee2ad97f, exception_lineno );
    }
